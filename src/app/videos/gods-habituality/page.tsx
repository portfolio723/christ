...
export const metadata: Metadata = {
  title: 'GOD\'s habituality never stops loving you',
  description: 'Why so much love?! 🤔It is on you!!! 🤷‍♀️',
};

export default function GodsHabitualityPage() {
  const videoSrc = "/vd6.mp4";
  return (
    <main className="bg-background text-white min-h-screen">
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": "GOD's habituality never stops loving you",
                "item": "https://godsspiritsays.com/videos/gods-habituality"
              }
            ]
          })
        }}
      ...
      <div className="relative pt-48 pb-20 bg-background">
        ...
        <div className="relative container mx-auto px-4 md:px-6 max-w-4xl text-center">
            ...
            𝐆𝐎𝐃'𝐬 habituality never stops loving you ❤️🌷🌸
            </h1>
        </div>
      </div>
...
{`Why so much love?! 🤔It is on you!!! 🤷‍♀️
