          ...
          <div className="max-w-5xl">
            <div className="flex flex-col items-start justify-between gap-8 rounded-lg bg-muted px-6 py-10 md:flex-row lg:px-20 lg:py-16">
              <div className="md:w-1/2">
                <h4 className="mb-1 text-2xl font-bold md:text-3xl text-white font-headline">{title}</h4>
              ...
              <div className="md:w-1/3">
                <ul className="flex flex-col space-y-2 text-sm font-medium text-white/80">
                  {items.map((item, idx) => (
