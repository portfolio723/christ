        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-muted rounded-md  aspect-square p-6 flex justify-between flex-col">
              ...
              <div className="flex flex-col">
                <h3 className="text-xl tracking-tight">Spiritual Growth</h3>
                <p className="text-muted-foreground max-w-xs text-base">
            ...
            <div className="bg-muted rounded-md aspect-square p-6 flex justify-between flex-col">
              ...
              <div className="flex flex-col">
                <h3 className="text-xl tracking-tight">Biblical Foundation</h3>
                <p className="text-muted-foreground max-w-xs text-base">
            ...
            <div className="bg-muted rounded-md h-full lg:col-span-2 p-6 aspect-square lg:aspect-auto flex justify-between flex-col">
              ...
              <div className="flex flex-col">
                <h3 className="text-xl tracking-tight">Global Vision</h3>
                <p className="text-muted-foreground max-w-xs text-base">
             ...
             <div className="bg-muted rounded-md aspect-square p-6 flex justify-between flex-col">
              <Heart className="w-8 h-8 stroke-1 text-primary" />
              <div className="flex flex-col">
                <h3 className="text-xl tracking-tight">Compassionate Love</h3>
                <p className="text-muted-foreground max-w-xs text-base">
             ...
             <div className="bg-muted rounded-md aspect-square p-6 flex justify-between flex-col">
              ...
              <div className="flex flex-col">
                <h3 className="text-xl tracking-tight">Divine Purpose</h3>
                <p className="text-muted-foreground max-w-xs text-base">
