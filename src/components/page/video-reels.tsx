    ...
    <section id="reels" className="relative w-full py-20 md:py-32 bg-background">
      ...
      >
        <div className="relative z-10 container mx-auto px-4 md:px-6">
          ...
          <div className="mt-16 grid grid-cols-1 items-center justify-items-center bg-card/50 backdrop-blur-sm px-4 py-4 rounded-xl border border-primary/20">
            <div className="text-white/90 text-lg md:text-xl font-crimson-pro space-y-4 text-left max-w-3xl pt-4">
